@extends('layouts.app', ['page' => 'Todas Transações', 'pageSlug' => 'transactions', 'section' => 'transactions'])
    ...
    <div class="col-md-12">
        <div class="card ">
            <div class="card-header">
                <div class="row">
                    <div class="col-8">
                        <h4 class="card-title">Todas Transações</h4>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ route('transactions.create', ['type' => 'expense']) }}" class="btn btn-sm btn-primary">Despesas</a>
                    <a href="{{ route('sales.create') }}" class="btn btn-sm btn-primary">Vendas</a>
                    <a href="{{ route('transfer.create') }}" class="btn btn-sm btn-primary">Transferências</a>
                </div>
            </div>
        </div>
    </div>
