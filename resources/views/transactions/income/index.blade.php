@extends('layouts.app', ['page' => 'Registar Entrada', 'pageSlug' => 'incomes', 'section' => 'transactions'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('transactions.create', ['type' => 'income']) }}" class="btn btn-sm btn-primary">Registar Entrada</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
