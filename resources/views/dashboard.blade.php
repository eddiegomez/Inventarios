@extends('layouts.app', ['pageSlug' => 'dashboard', 'page' => 'Relatório', 'section' => ''])
            ...
            <div class="card-header ">
                <div class="row">
                    <div class="col-sm-6 text-left">
                        ...
                        <h2 class="card-title">Resumo anual</h2>
                    </div>
                    <div class="col-sm-6">
...
<div class="row">
    <div class="col-lg-4">
        <div class="card card-chart">
            <div class="card-header">
                <h5 class="card-category">Registo do ultimo mês</h5>
    ...
    <div class="col-lg-4">
        <div class="card card-chart">
            <div class="card-header">
                <h5 class="card-category">Despesas no mês passado</h5>
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-4 text-right">
                        <a href="{{ route('sales.create') }}" class="btn btn-sm btn-primary">Nova venda</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
